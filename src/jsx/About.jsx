...
const About = (props) => {
	return (
		<div id='content'>
			...
			<p>At erat pellentesque adipiscing commodo elit at imperdiet dui accumsan. Purus in massa tempor nec feugiat. Mauris commodo quis imperdiet massa tincidunt nunc. At varius vel pharetra vel turpis nunc. Vestibulum rhoncus est pellentesque elit ullamcorper dignissim. Morbi tristique senectus et netus et malesuada. Nibh sit amet commodo nulla facilisi nullam vehicula ipsum a. Ullamcorper velit sed ullamcorper morbi tincidunt ornare massa eget egestas. Lacinia at quis risus sed vulputate odio ut enim. Amet consectetur adipiscing elit ut aliquam purus. Morbi non arcu risus quis varius. Amet consectetur adipiscing elit ut aliquam purus sit.</p>
			<h4>Lorem</h4>
			<h4>Ipsum</h4>
			<h4>Pudoram</h4>
			<h5>Itala</h5>
